...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105374652650548112)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105376673194548113)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105377076941548114)
,p_plug_name=>'Upload a File'
,p_parent_plug_id=>wwv_flow_imp.id(105376673194548113)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105379114489548116)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(105382083317548119)
,p_name=>'Preview'
...
'                  p_xlsx_sheet_name   => case when :P11_XLSX_WORKSHEET is not null then :P11_XLSX_WORKSHEET end,',
'                  p_file_profile      => apex_data_loading.get_file_profile( p_static_id => ''user_accounts'' ),',
'                  p_max_rows          => 100 ) ) p',
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2390148548659127)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2390507182659128)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2390940428659128)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2391317628659128)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2391658794659129)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2392126217659129)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2392507908659129)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2392934524659129)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2393292104659130)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2393655291659130)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2394083009659130)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2394891134659133)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105374652650548112)
,p_button_name=>'CLEAR'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2395318258659133)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(2401852047659142)
,p_branch_name=>'Go To Page 6'
,p_branch_action=>'f?p=&APP_ID.:6:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(2395318258659133)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(105384411050548132)
,p_name=>'P11_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(105377076941548114)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(105384724011548134)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(105387504943548136)
,p_name=>'P11_FILE_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(105379114489548116)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(105388701713548137)
,p_name=>'P11_XLSX_WORKSHEET'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(105379114489548116)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(2398382468659139)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(2398779884659139)
...
,p_associated_item=>wwv_flow_imp.id(105384411050548132)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2399883050659140)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2400441989659141)
,p_event_id=>wwv_flow_imp.id(2399883050659140)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2400807757659141)
,p_name=>'Submit worksheet on change'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P11_XLSX_WORKSHEET'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2401333634659141)
,p_event_id=>wwv_flow_imp.id(2400807757659141)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2399114667659139)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_DATA_LOADING'
,p_process_name=>'Load Data'
,p_attribute_01=>wwv_flow_imp.id(51306385199436346)
,p_attribute_02=>'FILE'
,p_attribute_03=>'P11_FILE'
,p_attribute_06=>'P11_XLSX_WORKSHEET'
,p_attribute_08=>'P11_ERROR_ROW_COUNT'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(2395318258659133)
,p_internal_uid=>54077462132106535
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2399538044659140)
...
,p_internal_uid=>54077885509106536
);
